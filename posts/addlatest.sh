...
latest_release_link="[Latest Release: ${release_number}](reimakesgames.github.io/reignite-ts/releases/${release_number}.html)"
...
for release in "${recent_releases[@]}"; do
  ...
  release_link="[Release: ${release_number}](reimakesgames.github.io/reignite-ts/releases/${release_number}.html)"
  # Append the link to the index.md file
